...
const Skills = () => {
  return (
    <section
      id="skills"
      className="relative flex flex-col justify-center items-center border-t my-12 lg:my-24 border-[#25213b] min-h-[70vh] scroll-mt-24"
    >
      {/* background glow */}
      <div className="w-[100px] h-[100px] bg-violet-100 rounded-full absolute top-6 left-1/2 -translate-x-1/2 filter blur-3xl opacity-20"></div>
      ...
      {/* Skills carousel */}
      <div className="w-full my-12 flex items-center lg:max-w-[85%]">
        <Marquee
          gradient={false}
          speed={80}
          pauseOnHover={true}
          ...
          {skills.map((skill, id) => (
            ...
            >
              <div className="">
                ...
                <div className="flex -translate-x-[20px] justify-center">
                  <div className="w-3/4">
                    <div className="h-[1px] w-full bg-gradient-to-r from-transparent via-violet-500 to-transparent" />
                  </div>
                </div>
